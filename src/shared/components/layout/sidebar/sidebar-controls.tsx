 ...
 * Theme, language, and currency toggle buttons.
 */
    ...
    <div className="px-3 py-3 border-b border-zinc-200/80 dark:border-zinc-800/80">
      <div className={cn("flex gap-1", isCollapsed ? "flex-col items-center" : "justify-center")}>
        ...
        >
          ...
          {!isCollapsed && (
            <span className="ml-1.5 text-[11px] font-semibold text-zinc-500 dark:text-zinc-400">{currency}</span>
          )}
        </button>
      </div>
    </div>
