...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "p-4 bg-white dark:bg-zinc-900 rounded-xl [--cell-size:2.5rem]",
        className
      )}
      ...
      classNames={{
        ...
        button_previous: cn(
          "h-9 w-9 bg-transparent p-0 opacity-80 hover:opacity-100 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-lg transition-colors",
        ...
        month_caption: cn(
          "flex h-10 w-full items-center justify-center font-semibold text-base text-zinc-900 dark:text-white",
        ...
        weekday: cn(
          "text-zinc-500 dark:text-zinc-400 flex-1 select-none text-sm font-semibold uppercase",
        ...
        today: cn(
          "bg-cyan-50 dark:bg-cyan-950/30 text-cyan-600 dark:text-cyan-400 rounded-lg font-semibold",
