...
interface AddBoardModalProps {
  isOpen: boolean;
  editingBoard?: IBoardSummary;
  onClose: () => void;
  onSave: (data: { title: string; description?: string; coverImage?: string }) => Promise<void>;
}
...
export function AddBoardModal({ isOpen, editingBoard, onClose, onSave }: AddBoardModalProps) {
  ...
  useEffect(() => {
    if (editingBoard) {
      ...
      setCoverImage(editingBoard.coverImage ?? "");
    } else {
